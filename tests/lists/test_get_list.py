...
def test_get_list(client):
    ...
    # GET lists and confirm success
    get_list_response_1 = client.get(f"{lists_address}/{list_names[0]}")
    get_list_response_2 = client.get(f"{lists_address}/{list_names[1]}")
    get_list_response_3 = client.get(f"{lists_address}/{list_names[2]}")
    get_list_response_4 = client.get(f"{lists_address}/{list_names[3]}")
    get_list_response_5 = client.get(f"{lists_address}/{list_names[4]}")
    get_list_response_6 = client.get(f"{lists_address}/{list_names[5]}")

    assert get_list_response_1.status_code == 200
    assert get_list_response_2.status_code == 200
    assert get_list_response_3.status_code == 200
    assert get_list_response_4.status_code == 200
    assert get_list_response_5.status_code == 200
    assert get_list_response_6.status_code == 200

    # Remove lists and confirm DELETE requests for removed lists return 204
    ...
    # Confirm GET requests for missing lists return 404
    bad_get_reponse_1 = client.get(f"{lists_address}/{list_names[0]}")
    bad_get_reponse_2 = client.get(f"{lists_address}/{list_names[1]}")
    bad_get_reponse_3 = client.get(f"{lists_address}/{list_names[2]}")
    bad_get_reponse_4 = client.get(f"{lists_address}/{list_names[3]}")
    bad_get_reponse_5 = client.get(f"{lists_address}/{list_names[4]}")
    bad_get_reponse_6 = client.get(f"{lists_address}/{list_names[5]}")
    ...
    assert bad_get_reponse_5.status_code == 404
    assert bad_get_reponse_6.status_code == 404
