...
def test_get_chemical(client):
    ...
    get_reponse_1 = client.get(f"chemicals/{purchased_chem_id_1}")
    get_reponse_2 = client.get(f"chemicals/{purchased_chem_id_2}")
    get_reponse_3 = client.get(f"chemicals/{prepared_chem_id_1}")
    #get_reponse_4 = client.get(f"chemicals/{prepared_chem_id_2}")
    ...
    bad_get_reponse_1 = client.get(f"chemicals/{purchased_chem_id_1}")
    bad_get_reponse_2 = client.get(f"chemicals/{purchased_chem_id_2}")
    bad_get_reponse_3 = client.get(f"chemicals/{prepared_chem_id_1}")
    #bad_get_reponse_4 = client.get(f"chemicals/{prepared_chem_id_2}")
