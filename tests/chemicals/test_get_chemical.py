...
testing strategystrategy. See docs/specification.md for a comprehensive view of system 
integration testing.
"""
...
def test_get_chemical(
    ...
    get_reponse_1 = client.get(f"{chemicals_address}/{purchased_chem_id_1}")
    get_reponse_2 = client.get(f"{chemicals_address}/{purchased_chem_id_2}")
    get_reponse_3 = client.get(f"{chemicals_address}/{prepared_chem_id_1}")
    get_reponse_4 = client.get(f"{chemicals_address}/{prepared_chem_id_2}")
    ...
    # Remove chemicals and confirm GET requests for removed chemicals return 204
    delete_reponse_1 = client.delete(f"{chemicals_address}/{purchased_chem_id_1}")
    delete_reponse_2 = client.delete(f"{chemicals_address}/{purchased_chem_id_2}")
    delete_reponse_3 = client.delete(f"{chemicals_address}/{prepared_chem_id_1}")
    delete_reponse_4 = client.delete(f"{chemicals_address}/{prepared_chem_id_2}")
    ...
    bad_get_reponse_1 = client.get(f"{chemicals_address}/{purchased_chem_id_1}")
    bad_get_reponse_2 = client.get(f"{chemicals_address}/{purchased_chem_id_2}")
    bad_get_reponse_3 = client.get(f"{chemicals_address}/{prepared_chem_id_1}")
    bad_get_reponse_4 = client.get(f"{chemicals_address}/{prepared_chem_id_2}")
